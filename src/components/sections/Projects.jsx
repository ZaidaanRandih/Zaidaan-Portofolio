                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-red-500/30 hover:shadow-[0_2px_8px_rgba(244,67,54,0.1)] transition-all">
                            ...
                            <div className="flex justify-between items-center">
                                <a href="https://github.com/ZaidaanRandih/PayPlus" className="text-red-400 hover:text-red-300 transition-colors my-4 flex items-center"> View Project → <img src="/github.png" className="w-6 h-6 ml-2" /> </a>
                            </div>
                        </div>
                        ...
                        <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-red-500/30 hover:shadow-[0_2px_8px_rgba(244,67,54,0.1)] transition-all">
                            ...
                            <div className="flex justify-between items-center">
                                <a href="https://github.com/ZaidaanRandih/TBA" className="text-red-400 hover:text-red-300 transition-colors my-4 flex items-center"> View Project → <img src="/github.png" className="w-6 h-6 ml-2" /> </a>
                            </div>
                        </div>
                        ...
                        <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-red-500/30 hover:shadow-[0_2px_8px_rgba(244,67,54,0.1)] transition-all">
                            ...
                            <div className="flex justify-between items-center">
                                <a href="https://github.com/ZaidaanRandih/Image-recognition-AdjwaMedjool" className="text-red-400 hover:text-red-300 transition-colors my-4 flex items-center"> View Project → <img src="/github.png" className="w-6 h-6 ml-2" /> </a>
                            </div>
                        </div>
                        ...
                        <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-red-500/30 hover:shadow-[0_2px_8px_rgba(244,67,54,0.1)] transition-all">
                            ...
                            <div className="flex justify-between items-center">
                                <a href="https://zaidaanrandih.github.io/TubesSA/" className="text-red-400 hover:text-red-300 transition-colors my-4 flex items-center"> View Project → <img src="/link.png" className="w-6 h-6 ml-2" /> </a>
                            </div>
                        </div>
